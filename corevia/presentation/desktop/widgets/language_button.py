...
class LanguageButton(QToolButton):
    ...
    def _apply_translations(
        ...
        *_args,
        ...
        self.setToolTip(self._i18n.tr("language.change"))

        self._menu.clear()

        english_action = self._menu.addAction(self._i18n.tr("language.english"))
        russian_action = self._menu.addAction(self._i18n.tr("language.russian"))
